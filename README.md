...
<html lang="id">
  <head>
  <meta charset="UTF-8" />
  <title>Link IG Kelompok 236</title>
  <style>
    body {
      background-color: #fef6ec; /* Beige pastel */
    ...
    .flower-title::before {
      background-image: url('flower-left.png');
    }
    .flower-title::after {
      background-image: url('flower-right.png');
    }
